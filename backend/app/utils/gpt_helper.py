...
✅ "[excited] Привет! Сегодня невероятная новость!"
✅ "И тут я понял... [long pause] это конец."
✅ "Ну что сказать [sighs] жизнь штука сложная."

Примеры неправильного использования:
❌ "[excited] Привет! [happy] Сегодня [curious] у нас новость!" (слишком много)
❌ Текст без тегов вообще (слишком мало)
...
Верни ТОЛЬКО текст для озвучки с аудио-тегами, без комментариев:"""
        ...
        try:
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "Ты эксперт по созданию сценариев для подкастов с эмоциональными аудио-тегами."},
